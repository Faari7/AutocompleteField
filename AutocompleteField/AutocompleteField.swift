    ...
    private func setLabelContent(_ text : String = "")
    {
        ...
        let attributedString = NSMutableAttributedString(
            ...
            attributes: [
                ...
                NSAttributedStringKey.foregroundColor: self.completionColor
            ]
        )
    ...
    fileprivate func suggestionToShow(_ searchTerm : String) -> String
    {
        ...
        for suggestion in self.suggestions
        {
                ...
                suggestion.lowercased().hasPrefix(searchTerm.lowercased()))
            {
                ...
                suggestionToReturn = suggestionToReturn + suggestion.substring(with: (suggestion.index(suggestion.startIndex, offsetBy: searchTerm.count) ..< suggestion.endIndex))
